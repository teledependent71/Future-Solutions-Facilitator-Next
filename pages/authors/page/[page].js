...
import authorsPageInitialPaths2a933Resource from '../../../resources/authors-page-initial-paths-2a933'
import authorsPageInitialProps4bf75Resource from '../../../resources/authors-page-initial-props-4bf75'
...
export async function getStaticPaths() {
  const response = await authorsPageInitialPaths2a933Resource({})
...
export async function getStaticProps(context) {
  const response = await authorsPageInitialProps4bf75Resource({
    ...context?.params,
